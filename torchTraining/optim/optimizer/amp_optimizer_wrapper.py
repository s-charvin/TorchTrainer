...
from torchTraining.utils.device import (is_cuda_available, is_mlu_available,
                             is_npu_available)
from torchTraining.utils.registry import OPTIM_WRAPPERS
from torchTraining.utils import digit_version
...
class AmpOptimWrapper(OptimWrapper):
    ...
    Args:
        loss_scale (float or str or dict): The initial configuration of
            ...
            introduction at `PyTorch AMP <https://pytorch.org/docs/stable/amp.html?highlight=gradscalertorch.cuda.amp.GradScaler>`_
            Defaults to ``dynamic``.
    ...
    def optim_context(self, model: nn.Module):
        ...
        """
        from torchTraining.runner.amp import autocast
