...
from torchTraining.utils.registry import HOOKS, MODELS
...
class EMAHook(Hook):
    ...
    Args:
        ema_type (str): The type of EMA strategy to use. You can find the
            supported strategies in :mod:`torchTraining.model.averaged_model`.
    ...
    def after_load_checkpoint(self, runner, checkpoint: dict) -> None:
        ...
        Args:
            runner (Runner): The runner of the testing process.
        """
        from torchTraining.runner.checkpoint import load_state_dict
