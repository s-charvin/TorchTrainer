...
from torchTraining.utils.dist import get_dist_info
from torchTraining.utils.fileio import FileClient, get_file_backend
from torchTraining.utils.fileio import load as load_file
from torchTraining.utils.logging import print_log
from torchTraining.model import is_model_wrapper
from torchTraining.utils import (
    apply_to,
    deprecated_function,
    digit_version,
    mkdir_or_exist,
)
from torchTraining.utils.dl_utils import load_url
...
def get_torchvision_models():
    ...
    if digit_version(torchvision.__version__) < digit_version("0.13.0a0"):
        ...
        json_path = osp.join(torchTraining.__path__[0], "hub/torchvision_0.12.json")
        model_urls = torchTraining.load(json_path)
...
def get_external_models():
    ...
    default_json_path = osp.join(torchTraining.__path__[0], "hub/openmmlab.json")
...
def get_mmcls_models():
    mmcls_json_path = osp.join(torchTraining.__path__[0], "hub/mmcls.json")
...
def get_deprecated_model_names():
    deprecate_json_path = osp.join(torchTraining.__path__[0], "hub/deprecated.json")
...
def save_checkpoint(checkpoint, filename, file_client_args=None, backend_args=None):
    ...
    Args:
        ...
        file_client_args (dict, optional): Arguments to instantiate a
            FileClient. See :class:`torchTraining.utils.FileClient` for details.
