...
import torchTraining
from torchTraining.config import Config, ConfigDict
from torchTraining.datasets import worker_init_fn as default_worker_init_fn
from torchTraining.utils.device import get_device
...
from torchTraining.evaluator import Evaluator
from torchTraining.utils.fileio import FileClient, join_path
from torchTraining.hooks import Hook
from torchTraining.utils.logging import MessageHub, MMLogger, print_log
...
from torchTraining.optim import (
    OptimWrapper,
    OptimWrapperDict,
    _ParamScheduler,
    build_optim_wrapper,
)
from torchTraining.utils.registry import (
    DATA_SAMPLERS,
    DATASETS,
    EVALUATOR,
    FUNCTIONS,
...
from torchTraining.utils import apply_to, digit_version, get_git_hash, is_seq_of
from torchTraining.utils.dl_utils import (
    TORCH_VERSION,
    collect_env,
    set_multi_processing,
)
from torchTraining.utils.visualization import Visualizer
...
class Runner:
    ...
    def __init__(
        ...
        torchTraining.mkdir_or_exist(self._work_dir)
        ...
        torchTraining.mkdir_or_exist(self._log_dir)
    ...
    def resume(
        ...
        if "config" in checkpoint["meta"]:
            config = torchTraining.Config.fromstring(
    ...
    def save_checkpoint(
        ...
        Args:
            ...
            file_client_args (dict, optional): Arguments to instantiate a
                FileClient. See :class:`torchTraining.utils.FileClient` for
        ...
        meta.update(
            ...
            mmengine_version=torchTraining.__version__ + get_git_hash(),
        )
    ...
    def _check_scheduler_cfg(
        ...
        Examples:
            ...
            >>> from torchTraining.optim import MultiStepLR
