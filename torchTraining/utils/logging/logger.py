...
from torchTraining.utils.manager import _accquire_lock, _release_lock
...
def _get_world_size():
    ...
    try:
        # requires torch
        from torchTraining.utils.dist import get_world_size
    except ImportError:
        return 1
    else:
...
def _get_rank():
    ...
    try:
        # requires torch
        from torchTraining.utils.dist import get_rank
    except ImportError:
        return 0
    else:
        return get_rank()
