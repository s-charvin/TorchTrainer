...
from torchTraining.model import BaseModel
from torchTraining.runner import Runner
from torchTraining.evaluator import BaseMetric
from torchTraining.structures import label_data, ClsDataSample
...
def main():
    ...
    dataset = dict(
        ...
        transforms=[
            ...
            dict(type="PackAudioClsInputs", keys=["mfcc"]),
        ],
    )
