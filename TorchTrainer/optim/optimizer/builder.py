...
from TorchTrainer.utils.device import is_npu_available, is_npu_support_full_precision
from TorchTrainer.utils.registry import OPTIM_WRAPPER_CONSTRUCTORS, OPTIMIZERS
