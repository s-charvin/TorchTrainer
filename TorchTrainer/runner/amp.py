...
from TorchTrainer.utils.device import (get_device, is_cuda_available, is_mlu_available,
                             is_npu_available)
...
def autocast(device_type: Optional[str] = None,
    ...
    assert digit_version(TORCH_VERSION) >= digit_version('1.5.0'), (
        'The minimum pytorch version requirements of TorchTrainer is 1.5.0, but '
        f'got {TORCH_VERSION}')
