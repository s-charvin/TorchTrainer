...
class LocalVisBackend(BaseVisBackend):
    ...
    Examples:
        >>> from TorchTrainer.visualization import LocalVisBackend
        >>> import numpy as np
...
class WandbVisBackend(BaseVisBackend):
    ...
    Examples:
        >>> from TorchTrainer.visualization import WandbVisBackend
        >>> import numpy as np
...
class TensorboardVisBackend(BaseVisBackend):
    ...
    Examples:
        >>> from TorchTrainer.visualization import TensorboardVisBackend
        >>> import numpy as np
...
class MLflowVisBackend(BaseVisBackend):
    ...
    Examples:
        >>> from TorchTrainer.visualization import MLflowVisBackend
        >>> from TorchTrainer import Config
        >>> import numpy as np
...
class ClearMLVisBackend(BaseVisBackend):
    ...
    Examples:
        >>> from TorchTrainer.visualization import ClearMLVisBackend
        >>> from TorchTrainer import Config
        >>> import numpy as np
