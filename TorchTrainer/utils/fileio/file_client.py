...
from TorchTrainer.utils import is_filepath
...
class FileClient:
    ...
    Warning:
        ...
        in https://TorchTrainer.readthedocs.io/en/latest/api/fileio.html#file-io
    ...
    def __new__(cls, backend=None, prefix=None, **kwargs):
        print_log(
            ...
            'functions in '
            'https://TorchTrainer.readthedocs.io/en/latest/api/fileio.html#file-io',
            logger='current',
            level=logging.WARNING)
