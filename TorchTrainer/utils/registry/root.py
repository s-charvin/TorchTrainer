"""TorchTrainer provides 20 root registries to support using modules across
projects.

More datails can be found at
https://TorchTrainer.readthedocs.io/en/latest/advanced_tutorials/registry.html.
"""
...
OPTIM_WRAPPER_CONSTRUCTORS = Registry("optimizer_wrapper constructor")
# mangage all kinds of parameter schedulers like `MultiStepLR`
PARAM_SCHEDULERS = Registry("parameter_scheduler", build_func=build_scheduler_from_cfg)
