...
from TorchTrainer.utils.registry import Registry
from TorchTrainer.config import Config, ConfigDict

if TYPE_CHECKING:
    import torch.nn as nn

    from TorchTrainer.optim.scheduler import _ParamScheduler
...
def build_from_cfg(
    ...
    if not isinstance(registry, Registry):
        raise TypeError(
            "registry must be a TorchTrainer.Registry object, "
...
def build_runner_from_cfg(
    ...
    Examples:
        >>> from TorchTrainer.registry import Registry, build_runner_from_cfg
    ...
    assert isinstance(registry, Registry), (
        "registry should be a TorchTrainer.Registry object",
        f"but got {type(registry)}",
    )
    ...
    if isinstance(obj_type, str):
        ...
        if runner_cls is None:
            raise KeyError(
                ...
                "can be found at https://TorchTrainer.readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module"
            )
...
def build_model_from_cfg(
    ...
    """
    from TorchTrainer.model import Sequential
        ...
        if isinstance(scheduler_type, str):
            ...
            if scheduler_cls is None:
                raise KeyError(
                    ...
                    "as expected. More details can be found at https://TorchTrainer.readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module"
                )
