...
from TorchTrainer.utils.fileio.io import get_file_backend
...
from TorchTrainer.utils import is_seq_of, scandir
...
class LoggerHook(Hook):
    ...
    def after_test_epoch(
        ...
        runner.logger.info(log_str)
        dump(self._process_tags(tag), osp.join(runner.log_dir, self.json_log_path))
